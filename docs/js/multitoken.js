...
window.addEventListener('load', async function() {
    ...
    $('#new-multitoken-create').bind('click', async function () {
        ...
        const data = multitokenContract.methods.create(multitokenTokens, multitokenWeights, multitokenName, multitokenSymbol, 18).encodeABI();
